/**
 * @see {@link https://stackoverflow.com/questions/17184813/how-to-encode-decode-ascii85-in-javascript}
 */
...
export function decode_ascii85(a) {
    let c, d, e, f, g, h = String, l = "length", w = 255, x = "charCodeAt", y = "slice", z = "replace";
